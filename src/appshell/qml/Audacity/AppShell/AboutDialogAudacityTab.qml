...
ColumnLayout {
    ...
    QtObject {
        ...
        readonly property string versionSubtitle: qsTrc("appshell/about", "Kdacity the free, open source, cross-platform software for recording and editing sounds.")
    }
            ...
            Column {
                ...
                StyledTextLabel {
                    text: {
                        ...
                        return qsTrc("appshell/about", "Kdacity website: %1").arg('<a href="' + websiteUrl.url + '">' + websiteUrl.displayName + '</a>')
                    }
                    font: ui.theme.bodyFont
                }
                ...
                Column {
                    ...
                    StyledTextLabel {
                        text: qsTrc("appshell/about", "<b>Kdacity®</b> software is copyright © 1999-%1 K-CORP.").arg(new Date().getFullYear())
                        font: ui.theme.bodyFont
                    }

                    StyledTextLabel {
                        text: qsTrc("appshell/about", "The name <b>Kdacity</b> is a registered trademark.")
                        font: ui.theme.bodyFont
                    }
                }
            }
