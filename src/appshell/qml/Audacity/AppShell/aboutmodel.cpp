...
void AboutModel::copyRevisionToClipboard() const
{
    QApplication::clipboard()->setText(
        QString("OS: %1, Arch.: %2, Kdacity version (%3-bit): %4-%5, revision: github-kdacity-kdacity-%6")
...
QVariantList AboutModel::creditList() const
{
    static const QVariantList cached = [] {
        QVariantList creditList = {
            makeSection(QT_TRANSLATE_NOOP("appshell/about", "K-CORP Members"), buildCredits(sTeamMembers)),
            makeSection(QT_TRANSLATE_NOOP("appshell/about", "Emeritus"),
                        QT_TRANSLATE_NOOP("appshell/about", "Distinguished K-CORP members, not currently active"),
        ...
        creditList.append(makeSection(QT_TRANSLATE_NOOP("appshell/about", "Libraries"),
                                      QT_TRANSLATE_NOOP("appshell/about", "Kdacity includes code from the following projects:"),
